...
This tool allows you to find the SHA256 hashes of ISO files (and any other file) with just a few clicks. An .exe file has been generated using PyInstaller to make it easier to use on Windows systems. 
...
The script can be started with `python3 min256-finder.py` command.
